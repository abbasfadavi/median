...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{median_find_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{median_find.vhd} -lib {xil_defaultlib}}
		{{median_find_clock.xdc}}
		{{median_find.xdc}}
	}
	set SimPeriod 1e-08
	set SimTime 0.0001
	...
	set TopLevelModule {median_find}
	...
	dict set TopLevelPortInterface sig_in DatFile {median_find_sig_in.dat}
	...
	dict set TopLevelPortInterface sig_in ClockDomain {median_find}
	...
	dict set TopLevelPortInterface sig_out DatFile {median_find_sig_out.dat}
	...
	dict set TopLevelPortInterface sig_out ClockDomain {median_find}
	...
	dict set TopLevelPortInterface clk ClockDomain {median_find}
